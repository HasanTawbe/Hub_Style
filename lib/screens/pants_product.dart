...
class PantsProduct extends StatefulWidget {
  const PantsProduct({Key? key}) : super(key: key);

  @override
  State<PantsProduct> createState() => _PantsProductState();
}

class _PantsProductState extends State<PantsProduct> {
